...
type PathOption = "/vigitech-portal" | "/vigitech-portal/radar-portal";
...
export const Layout: React.FC = () => {
    ...
    return (
        <>
            <Header />
            {(currentPath !== "/vigitech-portal"
                && currentPath !== "/vigitech-portal/radar-portal"
                && currentPath !== "/vigitech-portal/faq"
                && currentPath !== "/vigitech-portal/about"
            ) ?
