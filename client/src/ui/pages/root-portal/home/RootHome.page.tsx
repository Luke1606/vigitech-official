      ...
      <section id="services" className="bg-white text-gray-800 px-6 py-20 relative">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-24 items-center">
          ...
          >
            ...
            <NavLink to="radar" className="bg-gradient-to-br from-fuchsia-400 via-violet-500 to-cyan-400 text-white font-semibold px-6 py-3 rounded-lg shadow-xl hover:scale-105 hover:shadow-violet-900 hover:shadow-xl transition duration-300">
              Access Radar
            </NavLink>
          </div>
        </div>
