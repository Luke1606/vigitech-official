        ...
        <main className="min-h-screen bg-blue-600 text-white">
            ...
            <section className="h-screen w-full bg-gradient-to-br from-indigo-800 via-purple-700 to-blue-700 text-white px-4 sm:px-6 text-center relative overflow-hidden flex items-center justify-center">
                ...
                <div className="relative z-10 max-w-4xl mx-auto" data-aos="fade-up" data-aos-duration="1500">
                    ...
                    <p className="text-lg md:text-xl text-white/80">
                        Estamos dando forma a un futuro más inteligente al convertir los datos en conocimiento y la innovación en impacto.
                    </p>
                    <button
                        onClick={() =>
            ...
            <section id="about" className="bg-white text-gray-800 px-4 sm:px-6 py-20 relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-5xl mx-auto text-center">
                    <h2 className="text-4xl font-bold mb-10" data-aos="fade-down">¿ Quiénes somos ?</h2>
                    <p className="text-lg text-gray-700 leading-relaxed mb-16" data-aos="fade-up" data-aos-duration="1000">
                        En Vigitech, creemos que la tecnología es más que innovación: es transformación.
                        Fundada con la misión de empoderar a los responsables de decisión mediante inteligencia digital seleccionada,
                        nuestra plataforma está diseñada para dar sentido a un panorama tecnológico en constante evolución.
                        A través de visualizaciones dinámicas, análisis estratégicos y mapeo por radar,
                        iluminamos tendencias y revelamos oportunidades ocultas en la complejidad.
                    </p>

                    <div className="grid md:grid-cols-3 gap-10 text-center" data-aos="zoom-in" data-aos-duration="1000">
                        {/* Pillars */}
                        {[
                            { title: "Claridad", icon: "/vigitech_about_clarity.jpg", desc: "Simplificamos la complejidad de los datos tecnológicos para que te concentres en lo que realmente importa." },
                            { title: "Visión", icon: "/vigitech_about_insight.jpg", desc: "Combinamos datos globales y filtros especializados para descubrir patrones estratégicos." },
                            { title: "Impacto", icon: "/vigitech_about_impact.jpg", desc: "Transformamos el análisis en acción, facilitando decisiones más inteligentes en todos los sectores." },
