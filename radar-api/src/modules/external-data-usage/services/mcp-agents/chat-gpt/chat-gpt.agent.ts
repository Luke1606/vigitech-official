...
export class ChatGPTAgent extends BaseMCPAgent {
    constructor(
        ...
        const ChatGptUrl: string = configService.get<string>('CHAT_GPT_API_URL') || 'https://chatgpt.openai.com';

        const apiKey: string = configService.get<string>('CHAT_GPT_API_Key') || 'apikey';
