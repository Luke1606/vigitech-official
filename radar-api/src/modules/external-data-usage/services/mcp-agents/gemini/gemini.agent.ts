...
export class GeminiAgent extends BaseMCPAgent {
    constructor(
        ...
        const geminiUrl: string = configService.get<string>('GEMINI_API_URL') || 'https://gemini.google.com';

        const apiKey: string = configService.get<string>('GEMINI_API_Key') || 'apikey';
