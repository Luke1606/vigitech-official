...
import { StackExchangeApiResponse, StackExchangeQuestion } from '../../types/stack-overflow/stack-exchange.types';
...
export class StackExchangeFetcher extends BaseFetcher {
    ...
    public async fetch(): Promise<void> {
        this.logger.log(`Collecting data from Stack Exchange API for quadrant ${this.quadrants.join()}...`);
