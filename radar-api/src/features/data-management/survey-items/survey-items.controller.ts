...
export class SurveyItemsController {
    ...
    @Get('recommended')
    async findAllRecommendations(@Req() request: AuthenticatedRequest): Promise<SurveyItemWithAnalysisType[]> {
    ...
    @Get('subscribed')
    async findAllSubscribed(@Req() request: AuthenticatedRequest): Promise<SurveyItemWithAnalysisType[]> {
