...
export class CodeGPTAgent extends BaseMCPAgent {
    constructor(
        ...
        const codeGptUrl: string = configService.get<string>('CODE_GPT_API_URL') || 'https://codegpt.com';

        const apiKey: string = configService.get<string>('CODE_GPT_API_Key') || 'apikey';
