...
import { Body, Controller, Get, Logger, Param, ParseDatePipe, ParseUUIDPipe } from '@nestjs/common';
...
export class SubscribedItemAnalysisController {
	private readonly Logger: Logger = new Logger('SubscribedItemAnalysisController');
	
	constructor (private readonly subscribedItemAnalysisService: SubscribedItemAnalysisService) {
